...
if(!$uppercase || !$lowercase || !$number || !$specialChars || strlen($password) < 8) {
    echo '<center><h3>Password should be at least 8 characters in length and should include at least one upper case letter, one number, and one special character.</h3></center>';
}else{
...
$myRegNo=addslashes($_POST['regno']);
$myEmail = $_POST['email'];
$myPassword = $_POST['password'];

//$newpass = md5($myPassword); //This will make your password encrypted into md5, a high security hash

$sql = mysqli_query($con, "INSERT INTO tbMembers(first_name, last_name,RegNo, email,password) 
VALUES ('$myFirstName','$myLastName','$myRegNo','$myEmail', '$myPassword') ");
...
echo "<tr><td>Reg NO:</td><td><input type='text' style='background-color:#999999; font-weight:bold;' name='regno' maxlength='15' value=''></td></tr>";
